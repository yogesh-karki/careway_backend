...
<body>
    ...
    <div class="page__intro">
        <div class="uk-container uk-container-small">
            <h1 class="pagetitle uk-text-center">Blogs</h1>
            <p>
                From rejuvenating your smile to addressing medical concerns, our Hair Transplant, Dental, and Medical post collection offers a range of topics to support your journey toward optimal health and beauty.
            </p>
        </div>
    </div>
            ...
            <div class="uk-grid uk-child-width-1-3@m uk-child-width-1-2@s uk-child-1-1">
                <div class="post">
                    ...
                    <div class="about__post">
                        ...
                        <p>
                            The hair transplantation without shaving method preferred by men and women with long hair
                        ...
                        <div>
                            <a href="./blogdetail.html" class="button">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="post">
