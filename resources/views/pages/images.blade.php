...
<body>
                    ...
                    <div class="uk-navbar-center">
                        ...
                        <ul class="uk-navbar-nav">
                            ...
                            <li class="uk-active"><a>Results</a>
                                <div class="uk-navbar-dropdown">
                                    <ul class="uk-nav uk-navbar-dropdown-nav">
                                        <li class="uk-active"><a href="./images.html">Photo gallery</a></li>
            ...
            <div class="uk-overlay-default uk-position-cover">
                <div class="uk-position-center">
                    <ul class="uk-breadcrumb">
                        <li><a href="./index.html">Home</a></li>
                        <li><a href="images.html">Results</a></li>
    ...
    <div class="page__intro">
        <div class="uk-container uk-container-small">
            <h1 class="pagetitle uk-text-center">Image Gallery</h1>
            <p>
                Hair transplantation is a permanent and effective hair transplant procedure that eliminates the problem
                of baldness in the desired area. Check out real photos of great results with Careway Medical.
            </p>
        </div>
    </div>
    ...
    <section class="results">
        <div class="uk-container"> 
            <div class="uk-margin-medium-bottom uk-grid uk-child-width-1-3@m uk-child-width-1-2@s" uk-lightbox="animation: slide">
                ...
                <div class="post">
                    <div class="post">
                        <a href="./images/rev10.jpg">
                            <img src="./images/rev10.jpg" alt="">
                            <div class="uk-overlay-default uk-position-cover">
                                <div class="uk-position-center">
                                    <span uk-overlay-icon></span>
                                </div>
