    ...
    <section class="results">
        <div class="uk-container"> 
            <div class="uk-grid uk-child-width-1-3@m uk-child-width-1-2@s">
                @php $vids = explode(',',$item->videos); @endphp
                @foreach($vids as $vid)
                <div class="post">
                    <iframe src="https://www.youtube-nocookie.com/embed/{{$vid}}?autoplay=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1" allowfullscreen uk-responsive uk-video="automute: true; autoplay: false;"></iframe>
