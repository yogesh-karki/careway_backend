...
<body>
                ...
                <div uk-navbar>
                    ...
                    <div class="uk-navbar-center">
                        ...
                        <ul class="uk-navbar-nav">
                            ...
                            <li class="uk-active"><a>Results</a>
                                <div class="uk-navbar-dropdown">
                                    <ul class="uk-nav uk-navbar-dropdown-nav">
                                        <li><a href="./images.html">Photo gallery</a></li>
                                        <li class="uk-active"><a href="./videos.html">Video Gallery</a></li>
                                    </ul>
                                </div></li>
            ...
            <div class="uk-overlay-default uk-position-cover">
                <div class="uk-position-center">
                    <ul class="uk-breadcrumb">
                        <li><a href="./index.html">Home</a></li>
                        <li><a href="videos.html">Results</a></li>
    ...
    <div class="page__intro">
        <div class="uk-container uk-container-small">
            <h1 class="pagetitle uk-text-center">Video Gallery</h1>
            <p>
                Hair transplantation is a permanent and effective hair transplant procedure that eliminates the problem
                of baldness in the desired area. Check out real videos of great results with Careway Medical.
            </p>
        </div>
    </div>
    ...
    <section class="results">
        <div class="uk-container"> 
            <div class="uk-grid uk-child-width-1-3@m uk-child-width-1-2@s">
                <div class="post">
                    <iframe src="https://www.youtube-nocookie.com/embed/c2pz2mlSfXA?autoplay=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1" allowfullscreen uk-responsive uk-video="automute: true; autoplay: false;"></iframe>
                    <div class="about__post">
                        <h5>Something about the video, not long enough. Only a few lines</h5>
                    </div>
                </div>
                <div class="post">
                    <iframe src="https://www.youtube.com/embed/Svp2MXZOXpQ?autoplay=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1" allowfullscreen uk-responsive uk-video="automute: true; autoplay: false;"></iframe>
                    <div class="about__post">
                        <h5>Something about the video, not long enough. Only a few lines</h5>
                    </div>
                </div>
                <div class="post">
                    <iframe src="https://www.youtube.com/embed/DBRpO9gq6bw?autoplay=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1" allowfullscreen uk-responsive uk-video="automute: true; autoplay: false;"></iframe>
                    <div class="about__post">
                        <h5>Something about the video, not long enough. Only a few lines</h5>
                    </div>
                </div>
                <div class="post">
                    <iframe src="https://www.youtube.com/embed/mx1V0f9YLrE?autoplay=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1" allowfullscreen uk-responsive uk-video="automute: true; autoplay: false;"></iframe>
                    <div class="about__post">
                        <h5>Something about the video, not long enough. Only a few lines</h5>
                    </div>
                </div>
                <div class="post">
                    <iframe src="https://www.youtube.com/embed/F6iZr6kZ5aA?autoplay=0&amp;showinfo=0&amp;rel=0&amp;modestbranding=1&amp;playsinline=1" allowfullscreen uk-responsive uk-video="automute: true; autoplay: false;"></iframe>
                    <div class="about__post">
                        <h5>Something about the video, not long enough. Only a few lines</h5>
                    </div>
                </div>
