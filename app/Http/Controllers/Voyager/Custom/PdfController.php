...
class PdfController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $dataTypeContent = $dataTypeContent->where('link_id',request('link_id'));
    ...
    public function order(Request $request)
    {
        ...
        $results = $query->orderBy($dataType->order_column, $dataType->order_direction)->where('link_id', $request->link_id)->get();
